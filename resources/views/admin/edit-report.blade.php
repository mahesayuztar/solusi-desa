...
<main>
    <div class="head-title">
        ...
        <ul class="breadcrumb">
            ...
            <li><i class='bx bx-chevron-right'></i></li>
            <li>
            <a class="active" href="{{ url('/edit-report/{id}') }}">Edit Data Laporan</a>
            </li>
        </ul>
        </div>
    </div>
    ...
    <div class="table-data">
        <div class="order">
            ...
            @endif
            <form method="POST" action="{{ url('update-report') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="input-wrap">
                    ...
                    <input type="text" class="form-control" name="nohp" placeholder="Masukkan Nomor Telepon" value="{{ $data->nohp }}">
                    @error('nohp')
                        <div class="text-danger">
                            <i class="bx bx-error-circle error-icon"></i>
                            {{ $message }}
                ...
                <div class="input-wrap">
                    ...
                    <input type="text" class="form-control" name="deskripsi" placeholder="Masukkan Deskripsi Perkara" value="{{ $data->deskripsi }}">
                    @error('deskripsi')
                        <div class="text-danger">
                            <i class="bx bx-error-circle error-icon"></i>
                            {{ $message }}
                ...
                <div class="input-wrap">
                    ...
                    <input type="text" class="form-control" name="kronologi" placeholder="Masukkan Kronologi Kejadian" value="{{ $data->kronologi }}">
                    @error('kronologi')
                        <div class="text-danger">
                            <i class="bx bx-error-circle error-icon"></i>
                            {{ $message }}
